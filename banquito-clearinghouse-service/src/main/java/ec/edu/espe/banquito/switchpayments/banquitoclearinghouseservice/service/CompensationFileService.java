...
public class CompensationFileService {
    ...
    public void generateSpiFile() {
        ...
        try {
            ...
            file.setStatus(ec.edu.espe.banquito.switchpayments.banquitoclearinghouseservice.enums.FileStatus.GENERATED);
    ...
    private CompensationFile buildCompensationFile(
        ...
        file.setTotalAmount(total);
        file.setStatus(
                ec.edu.espe.banquito.switchpayments.banquitoclearinghouseservice.enums.FileStatus.GENERATED
        );
        file.setGeneratedAt(LocalDateTime.now(APP_ZONE));
