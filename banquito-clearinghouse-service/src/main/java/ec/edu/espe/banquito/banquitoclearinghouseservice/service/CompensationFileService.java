...
import ec.edu.espe.banquito.banquitoclearinghouseservice.enums.PaymentStatus;
import ec.edu.espe.banquito.banquitoclearinghouseservice.exception.AccountingIntegrationException;
import ec.edu.espe.banquito.banquitoclearinghouseservice.exception.FileGenerationException;
import ec.edu.espe.banquito.banquitoclearinghouseservice.model.CompensationFile;
import ec.edu.espe.banquito.banquitoclearinghouseservice.model.OffUsPayment;
import ec.edu.espe.banquito.banquitoclearinghouseservice.repository.CompensationFileRepository;
import ec.edu.espe.banquito.banquitoclearinghouseservice.repository.OffUsPaymentRepository;
...
public class CompensationFileService {
    ...
    public void generateSpiFile() {
        ...
        try {
            ...
            file.setStatus(ec.edu.espe.banquito.banquitoclearinghouseservice.enums.FileStatus.GENERATED);
    ...
    private CompensationFile buildCompensationFile(
        ...
        file.setTotalAmount(total);
        file.setStatus(
                ec.edu.espe.banquito.banquitoclearinghouseservice.enums.FileStatus.GENERATED
        );
        file.setGeneratedAt(LocalDateTime.now(APP_ZONE));
